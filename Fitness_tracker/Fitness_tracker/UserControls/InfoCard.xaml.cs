...
{
    /// <summary>
    /// Interaktionslogik für InfoCard.xaml
    /// </summary>
    public partial class InfoCard : UserControl
    {
        ...
        {
            get
            { return (string)GetValue(PercentageProperty); }
        ...
        {
            get
            { return (string)GetValue(DaysProperty); }
        ...
        {
            get
            { return (MahApps.Metro.IconPacks.PackIconMaterialKind)GetValue(IconProperty); }
