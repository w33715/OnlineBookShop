        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MediineId = table.Column<int>(type: "int", nullable: false),
                    Company = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicineReports_Medicines_MediineId",
                        column: x => x.MediineId,
                        principalTable: "Medicines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicineReports_Suppliers_SuppliersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineReports_MediineId",
                table: "MedicineReports",
                column: "MediineId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicineReports_SuppliersId",
                table: "MedicineReports",
                column: "SuppliersId");
